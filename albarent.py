...
def add_car():
    layout = [[sg.Text("Targa: ", size=(10, 1)),
               sg.Text("Modeli: ", size=(10, 1)),
               sg.Text("Viti Prodhimit: ", size=(10, 1)),
               sg.Text("Fuqia Motorike (cc): ", size=(10, 1)),
               sg.Text("Naft/Benzin: ", size=(10, 1)),
               sg.Text("Vendet: ", size=(10, 1))],
              [sg.Input(size=(10, 1)),
               sg.Input(size=(10, 1)),
               sg.Input(size=(10, 1)),
               sg.Input(size=(10, 1)),
    ...
    while True:
        ...
        indexing_1 = value[0]
        print(type(indexing_1))
        indexing_1 = str(indexing_1)
        print(value[0][0:2])
        print("This is the test: ", indexing_1 == str())
        # print("This is the test: ",value[0][0:2]!= str(),
        # int(value[0][3:6]) != int(), value[0][7:9] != str())
        if value[0][0:2] == str() and int(value[0][3:6]) == int()\
                and value[0][7:9] == str():
